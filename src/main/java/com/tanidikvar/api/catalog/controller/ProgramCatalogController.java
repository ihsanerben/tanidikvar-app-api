...
public class ProgramCatalogController {
    ...
    @GetMapping("/catalog-programs") public PageResponse<ProgramSummaryResponse> programs(
            ...
            @RequestParam(defaultValue="20")int size){return service.list(q,city,institutionType,degreeLevel,scoreType,durationYears,rankFrom,rankTo,faculty,universityId,sort,page,size);}
