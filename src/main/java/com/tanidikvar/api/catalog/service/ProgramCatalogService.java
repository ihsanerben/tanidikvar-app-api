...
public class ProgramCatalogService {
    ...
    public PageResponse<ProgramSummaryResponse> list(String query,String city,String type,String level,String score,
        ...
        if(duration!=null&&(duration<1||duration>10)||rankFrom!=null&&rankFrom<1||rankTo!=null&&rankTo<1||rankFrom!=null&&rankTo!=null&&rankFrom>rankTo||scoreFrom!=null&&scoreFrom.signum()<0||scoreTo!=null&&scoreTo.signum()<0||scoreFrom!=null&&scoreTo!=null&&scoreFrom.compareTo(scoreTo)>0||year==null||year<2015||year>2025)bad();
        return new PageResponse<>(repository.list(q,c,t,l,s,duration,rankFrom,rankTo,scoreFrom,scoreTo,filled,year,f,universityId,page,size,order),page,size,
                repository.count(q,c,t,l,s,duration,rankFrom,rankTo,scoreFrom,scoreTo,filled,year,f,universityId));
    }
