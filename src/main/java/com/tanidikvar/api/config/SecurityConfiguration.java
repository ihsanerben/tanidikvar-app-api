    ...
    SecurityFilterChain security(HttpSecurity http, ObjectMapper mapper, @Qualifier("corsConfigurationSource") CorsConfigurationSource corsSource,
        ...
        return http.cors(cors -> cors.configurationSource(corsSource))
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/questions/*/answers", "/api/questions/*/admin-answers", "/api/questions/*/reports", "/api/me/admin-applications").hasAnyRole("USER", "YKS_ADAYI", "UNIVERSITE_OGRENCISI", "MEZUN", "TANIDIK")
                        .requestMatchers(HttpMethod.PUT, "/api/questions/*/like", "/api/questions/*/assignment", "/api/answers/*", "/api/answers/*/like", "/api/answers/*/status", "/api/admin-answers/*", "/api/admin-answers/*/status", "/api/questions/*").hasAnyRole("USER", "YKS_ADAYI", "UNIVERSITE_OGRENCISI", "MEZUN", "TANIDIK")
