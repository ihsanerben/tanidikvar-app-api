...
public class ManagementMapper {
 public ManagedUserResponse user(ManagedUser a){return new ManagedUserResponse(a.id(),a.email(),a.name(),a.authority(),a.educationStatus(),a.universityName(),a.departmentName(),a.emailVerified(),a.createdAt(),a.deletedAt(),a.version());}
 public ManagedContentResponse content(ManagedContent a){return new ManagedContentResponse(a.id(),a.kind(),a.questionId(),a.authorId(),a.title(),a.body(),a.authorName(),a.createdAt(),a.deletedAt(),a.moderatedAt(),a.archivedAt(),a.questionHidden(),a.viewCount(),a.likeCount(),a.communityAnswerCount(),a.adminAnswerCount(),a.version());}
