...
public class PublicAdminProfileController {
 ...
 public PageResponse<PublicAdminProfileResponse> search(@RequestParam(required=false) String q,@RequestParam(defaultValue="false") boolean activeOnly,@RequestParam(defaultValue="0") int page,@RequestParam(defaultValue="20") int size){return profiles.search(q,activeOnly,page,size);}
