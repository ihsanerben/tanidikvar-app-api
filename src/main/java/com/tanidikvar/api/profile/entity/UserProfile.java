...
public record UserProfile(UUID userId, String firstName, String lastName, EducationStatus educationStatus,
        UUID universityId, UUID departmentId, Integer classYear, Integer graduationYear, String biography, String occupation, String company, String linkedinUrl, String portfolioUrl,
