...
public class PublicAdminProfileRepository {
 ...
 v.university_name,v.department_name,v.education_status,v.graduation_year,p.biography,p.occupation,p.company,p.linkedin_url,p.portfolio_url,f.id avatar_file_id,
