...
public class PublicProfileRepository {
 ...
 """,(r,n)->new PublicProfile(r.getObject("id",UUID.class),r.getString("name"),r.getString("role"),r.getString("education_status"),r.getString("university_name"),r.getString("department_name"),r.getObject("graduation_year",Integer.class),r.getString("biography"),r.getString("occupation"),r.getString("company"),r.getString("linkedin_url"),r.getString("portfolio_url"),r.getObject("avatar_file_id",UUID.class),r.getTimestamp("created_at").toInstant()),id).stream().findFirst();}
}
