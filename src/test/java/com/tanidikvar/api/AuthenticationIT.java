...
class AuthenticationIT {
    ...
    @Test void authenticationTablesRejectPhysicalDeletion() {
        ...
        assertThatThrownBy(() -> jdbc.execute("TRUNCATE users, auth_sessions, auth_action_tokens, user_profiles, tags, management_actions, questions, question_tags, answers, admin_applications, stored_files"))
