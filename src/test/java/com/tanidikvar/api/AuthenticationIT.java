...
class AuthenticationIT {
    ...
    @Test void authenticationTablesRejectPhysicalDeletion() {
        ...
        assertThatThrownBy(() -> jdbc.execute("TRUNCATE manager_profiles, answer_likes, question_reports, question_likes, question_views, users, auth_sessions, auth_action_tokens, user_profiles, tags, management_actions, questions, question_tags, answers, admin_applications, stored_files, question_assignments"))
