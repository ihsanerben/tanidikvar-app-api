...
class ProfileCatalogIT {
    ...
    @Test void newTablesRejectPhysicalDeletion() {
        ...
        assertThatThrownBy(()->jdbc.execute("TRUNCATE user_profiles,tags,management_actions")).isInstanceOf(org.springframework.dao.DataIntegrityViolationException.class);
    }
}
