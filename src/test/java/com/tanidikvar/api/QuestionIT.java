...
class QuestionIT {
    ...
    @Test void invalidFieldsMissingTagsAndPhysicalDeleteAreRejected()throws Exception {
        ...
        assertThatThrownBy(()->jdbc.execute("TRUNCATE answer_likes, question_reports, question_likes, question_views, questions,question_tags, answers, question_assignments")).isInstanceOf(org.springframework.dao.DataAccessException.class);
    }
